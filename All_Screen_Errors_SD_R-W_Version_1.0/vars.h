...
enum FlowGlobalVariables {
    FLOW_GLOBAL_VARIABLE_MAX_RPM = 0,
    FLOW_GLOBAL_VARIABLE_MAX_TIME = 1,
    FLOW_GLOBAL_VARIABLE_MIN_RPM = 2,
    FLOW_GLOBAL_VARIABLE_STEP_RPM = 3,
    FLOW_GLOBAL_VARIABLE_STEP_TIME = 4,
    FLOW_GLOBAL_VARIABLE_MIN_TIME = 5
};
