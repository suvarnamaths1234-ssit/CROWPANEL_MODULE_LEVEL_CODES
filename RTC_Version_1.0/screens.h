...
typedef struct _objects_t {
    ...
    lv_obj_t *obj7;
    lv_obj_t *obj8;
    lv_obj_t *eror_clear_button;
    lv_obj_t *error_display;
    lv_obj_t *obj9;
    lv_obj_t *obj10;
    lv_obj_t *sd_data_logging;
    //lv_obj_t *data_log_on_off_switch;
    lv_obj_t *obj11;
    ...
    lv_obj_t *jar_number_on_info_screen;
    lv_obj_t *jar_info_reset;
    lv_obj_t *obj22;
    lv_obj_t *obj23;
    lv_obj_t *obj24;
    lv_obj_t *system_reset_btn;  // Add this for the button
    lv_obj_t *obj25;
    lv_obj_t *obj26;
    lv_obj_t *home_page;
    lv_obj_t *rtc_button;  // ← ADD THIS LINE
...
enum ScreensEnum {
    SCREEN_ID_MAIN = 1,
    SCREEN_ID_ERRORS_PAGE = 2,
    SCREEN_ID_DATA_LOG_PAGE = 3,
    SCREEN_ID_JAR_CONFIGURATION_PAGE = 4,
    SCREEN_ID_JAR_INFO_PAGE = 5,
